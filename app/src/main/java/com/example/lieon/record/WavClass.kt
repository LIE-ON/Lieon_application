...
class WavClass(path: String?, private val context: Context) {

    private var filePath: String? = path
    private val tempRawFile = "temp_record.raw"
    private val tempWavFile = "final_record.wav"
    private val bpp = 16
    ...
    private fun createWavFile(tempPath: String?, wavPath: String?) {
        try {
            ...
            val data = ByteArray(bufferSize)
            val channels = 2
            val byteRate = bpp * sampleRate * channels / 8L
